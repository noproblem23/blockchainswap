...
const ActionPanel: React.FunctionComponent<ActionPanelProps> = ({
  ...
  const core = `https://explorer.zksync.io/address/${lpAddress}`
  const info = `https://info.${MAIN_DOMAIN}/pair/${lpAddress}`
  ...
  return (
    <Container>
      <InfoContainer>
        <StakeContainer>
          <StyledLinkExternal href={`${EXCHANGE_URL}/#/add/${liquidityUrlPathParts}`}>
