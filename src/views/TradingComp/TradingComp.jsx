import { Flex, Button, Card, CardBody, CardHeader, Heading, Text, TimerIcon } from 'sugarswap-uikit'
...
function TradingComp({ id }) {
  ...
  return (
    <div>
      <BannerContainer>
        <StyledMobileBanner src={'/images/assets/banners/mobile_xsugar_banner.png'} alt={'banner'} />
        <StyledBanner src={'/images/assets/banners/xsugar_banner.png'} alt={'banner'} />
        <StyledContent>
          <div>
