...
import { Card, CardBody, Heading, Text } from 'sugarswap-uikit'
import { useWeb3React } from '@web3-react/core'
import { useTranslation } from 'contexts/Localization'
import useApproveConfirmTransaction from 'hooks/useApproveConfirmTransaction'
import { useSugar, useBunnyFactory } from 'hooks/useContract'
...
const Mint: React.FC = () => {
  ...
  const {
    ...
    onRequiresApproval: async () => {
      ...
      try {
        const response = await sugarContract.methods.allowance(account, bunnyFactoryContract.options.address).call()
