...
import { Modal, Box, Text } from 'sugarswap-uikit'
  ...
  return (
    <Modal title={t('Contribute %symbol%', { symbol: currency })} onDismiss={onDismiss}>
      <Box maxWidth="400px">
        ...
        <Text as="p" mb="24px">
          {t(
            "If you don't contribute enough WETH tokens, you may not receive any IDO tokens at all and will only receive a full refund of your WETH tokens.",
          )}
        </Text>
        ...
        />
        {/* <LinkExternal
          href={`${EXCHANGE_URL}/#/add/CORE/${currencyAddress}`}
