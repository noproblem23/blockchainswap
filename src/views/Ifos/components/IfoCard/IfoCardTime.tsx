...
import { Flex, Link } from 'sugarswap-uikit'
  ...
  return (
    <Details>
      ...
      <Link
        ...
        ml="8px"
      >
        {timeUntil.days > 0 && `${timeUntil.days} ${timeUntil.days === 1 ? 'day' : 'days'} `}
        {timeUntil.hours > 0 && `${timeUntil.hours} ${timeUntil.hours === 1 ? 'hr' : 'hrs'} `}
