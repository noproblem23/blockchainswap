...
import { Button, Text } from 'sugarswap-uikit'
  ...
  return (
    <Page>
      ...
      <Content>
        <div>
          <Block>
            <Title as="h2">Coming Soon to SugarSwap.</Title>
            <Text mb={3}>
            ...
            <Text mb={3}>
              <LiquidityLink href={`${EXCHANGE_URL}/#/add/BNB/0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56`}>
                Get BUSD
              </LiquidityLink>
            </Text>
            <Text mb={3}>
              The project gets the BNB, Sugarswap burns the SUGAR.
              <br />
          ...
          <Block>
            ...
            <Text mb={3}>
              Launch your project with SugarSwap, Cronos&apos;s most-used AMM project and liquidity provider, to bring
              your token directly to the most active and rapidly growing community on ZkSync Era.
            </Text>
            <Button
              as="a"
