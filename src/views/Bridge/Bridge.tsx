...
import { HelpIcon, useWalletModal, Input as UIKitInput, useModal, Button as ThemeButton } from 'sugarswap-uikit'
  ...
  useEffect(() => {
    const changeNetwork = async () => {
      ...
      if (provider) {
        ...
        console.error("Can't setup the ZkSync Era on metamask because window.ethereum is undefined")
        return false
      }
    }
            ...
            <DescContainer>
              ...
              <DescSubContainer valid>
                <div style={{ display: 'flex' }}>
                  <div>{'Minimum Fee '}</div>
                  <Tooltip
                    content={`Fee of 0.001 with a minimum fee of ${selectedToken.originUnderlying.symbol} and a maximum fee of 1,000 ${selectedToken.originUnderlying.symbol}. The fee is charged by Multichain, SugarSwap charges no additional fee.`}
                  >
