...
import { Heading, Card, CardBody, Flex, ArrowForwardIcon, Skeleton } from 'sugarswap-uikit'
import max from 'lodash/max'
import { NavLink } from 'react-router-dom'
import { useTranslation } from 'contexts/Localization'
import BigNumber from 'bignumber.js'
import { getFarmApy } from 'utils/apy'
import { useFarms, usePriceSugarUsd, useGetApiPrices } from 'state/hooks'
    ...
    const apys = farmsLP
      ...
      .map((farm) => {
        if (farm.lpTotalInQuoteToken && prices) {
          ...
          return getFarmApy(farm.poolWeight, sugarPrice, totalLiquidity, farm.tokenPerSecond)
        }
        return null
      })
