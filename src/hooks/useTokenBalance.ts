...
import { getBep20Contract, getSugarContract, getFactoryContract } from 'utils/contractHelpers'
...
export const useTotalSupply = () => {
  ...
  useEffect(() => {
    async function fetchTotalSupply() {
      const sugarContract = getSugarContract()
      const supply = await sugarContract.methods.totalSupply().call()
  ...
  useEffect(() => {
    const fetchBalance = async () => {
      ...
      const [tRes, res0, res1, res2] = await Promise.all([
        sugarContract.methods.totalSupply().call(),
        sugarContract.methods.balanceOf('0x40CF9Fd2a707DB5975aFE0Cf2F8599c37455d8Ea').call(), // deployer
        sugarContract.methods.balanceOf('0x7bf76646fbe70b13b72b0b46284f747eec5d0181').call(), // trade mining
        sugarContract.methods.balanceOf('0x000000000000000000000000000000000000dEaD').call(), // burn address
      ])
