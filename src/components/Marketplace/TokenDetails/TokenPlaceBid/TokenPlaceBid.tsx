      ...
      >
        ...
        >
          ...
          {steps[activeStep] === 'Sign' &&
            isPlaceBid &&
            `Please keep your ${bidAmount} WETH available in your wallet for the bid to be valid.`}
        </Typography>
        <Box
          style={{
            marginTop: '24px',
        ...
        >
          {activeStep === 0 && (
            <StyledSearch>
              ...
              <SearchIconWrapper>WETH</SearchIconWrapper>
            </StyledSearch>
          )}
        </Box>
        {activeStep === 0 && (
        ...
        {activeStep === 0 && (
          ...
          >
            ...
            >
              {new BigNumber(wcoreBalance).dp(2, 1).toString(10)} WETH
            </Typography>
          </Box>
        )}
        ...
        {steps[activeStep] === 'Convert' && (
          ...
          >
            ...
            >
              {new BigNumber(bidAmount).minus(wcoreBalance).toString(10)} WETH
            </Typography>
          </Box>
        )}
        ...
        >
          {new BigNumber(bidAmount).isGreaterThan(wcoreBalance) &&
            (steps[activeStep] === 'Bid amount' || steps[activeStep] === 'Convert') && (
              ...
              >
                {new BigNumber(bidAmount).minus(wcoreBalance).toString(10)} WETH will be converted to{' '}
                {new BigNumber(bidAmount).minus(wcoreBalance).toString(10)} WETH
              </Typography>
            )}
          {steps[activeStep] === 'Sign' && !isPlaceBid && !isBidLoading && (
            ...
            >
              You&apos;re placing a bid for {bidAmount} WETH
            </Typography>
          )}
          {steps[activeStep] === 'Sign' && !isPlaceBid && isBidLoading && (
            <Typography
